...
# read the templates
entity_template = env.get_template("entity_parser.template.txt")
typedef_template = env.get_template("type_parser.template.txt")

# initialise the schema parser and read the input
parser = SchemaParser()
schema = parser.read_schema_file('schemas/IFC4x1_FINAL.exp')
