...
class IfcRecurrencePattern(IfcEntity):
    ...
    def __json__(self):
        ...
        attrs = { 'RecurrenceType': self.RecurrenceType, 'DayComponent': self.DayComponent, 'WeekdayComponent': self.WeekdayComponent, 'MonthComponent': self.MonthComponent, 'Position': self.Position, 'Interval': self.Interval, 'Occurrences': self.Occurrences, 'TimePeriods': self.TimePeriods }
...
class IfcDimensionalExponents(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'LengthExponent': self.LengthExponent, 'MassExponent': self.MassExponent, 'TimeExponent': self.TimeExponent, 'ElectricCurrentExponent': self.ElectricCurrentExponent, 'ThermodynamicTemperatureExponent': self.ThermodynamicTemperatureExponent, 'AmountOfSubstanceExponent': self.AmountOfSubstanceExponent, 'LuminousIntensityExponent': self.LuminousIntensityExponent }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTableColumn(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Identifier': self.Identifier, 'Name': self.Name, 'Description': self.Description, 'Unit': self.Unit, 'ReferencePath': self.ReferencePath }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcReference(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'TypeIdentifier': self.TypeIdentifier, 'AttributeIdentifier': self.AttributeIdentifier, 'InstanceName': self.InstanceName, 'ListPositions': self.ListPositions, 'InnerReference': self.InnerReference }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcAddress(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Purpose': self.Purpose, 'Description': self.Description, 'UserDefinedPurpose': self.UserDefinedPurpose }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPerson(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Identification': self.Identification, 'FamilyName': self.FamilyName, 'GivenName': self.GivenName, 'MiddleNames': self.MiddleNames, 'PrefixTitles': self.PrefixTitles, 'SuffixTitles': self.SuffixTitles, 'Roles': self.Roles, 'Addresses': self.Addresses }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcShapeAspect(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'ShapeRepresentations': self.ShapeRepresentations, 'Name': self.Name, 'Description': self.Description, 'ProductDefinitional': self.ProductDefinitional, 'PartOfProductDefinitionShape': self.PartOfProductDefinitionShape }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcOrganization(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Identification': self.Identification, 'Name': self.Name, 'Description': self.Description, 'Roles': self.Roles, 'Addresses': self.Addresses }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTextStyle(IfcPresentationStyle):
    ...
    def __json__(self):
        ...
        attrs = { 'TextCharacterAppearance': self.TextCharacterAppearance, 'TextStyle': self.TextStyle, 'TextFontStyle': self.TextFontStyle, 'ModelOrDraughting': self.ModelOrDraughting }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSurfaceStyleLighting(IfcPresentationItem):
    ...
    def __json__(self):
        sup = IfcPresentationItem.__json__(self)
        attrs = { 'DiffuseTransmissionColour': self.DiffuseTransmissionColour, 'DiffuseReflectionColour': self.DiffuseReflectionColour, 'TransmissionColour': self.TransmissionColour, 'ReflectanceColour': self.ReflectanceColour }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTimeSeries(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'StartTime': self.StartTime, 'EndTime': self.EndTime, 'TimeSeriesDataType': self.TimeSeriesDataType, 'DataOrigin': self.DataOrigin, 'UserDefinedDataOrigin': self.UserDefinedDataOrigin, 'Unit': self.Unit }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLightDistributionData(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'MainPlaneAngle': self.MainPlaneAngle, 'SecondaryPlaneAngle': self.SecondaryPlaneAngle, 'LuminousIntensity': self.LuminousIntensity }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMapConversion(IfcCoordinateOperation):
    ...
    def __json__(self):
        ...
        attrs = { 'Eastings': self.Eastings, 'Northings': self.Northings, 'OrthogonalHeight': self.OrthogonalHeight, 'XAxisAbscissa': self.XAxisAbscissa, 'XAxisOrdinate': self.XAxisOrdinate, 'Scale': self.Scale }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcApproval(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Identifier': self.Identifier, 'Name': self.Name, 'Description': self.Description, 'TimeOfApproval': self.TimeOfApproval, 'Status': self.Status, 'Level': self.Level, 'Qualifier': self.Qualifier, 'RequestingApproval': self.RequestingApproval, 'GivingApproval': self.GivingApproval }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPresentationLayerAssignment(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'AssignedItems': self.AssignedItems, 'Identifier': self.Identifier }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRoot(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'GlobalId': self.GlobalId, 'OwnerHistory': self.OwnerHistory, 'Name': self.Name, 'Description': self.Description }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcFillAreaStyleHatching(IfcGeometricRepresentationItem):
    ...
    def __json__(self):
        sup = IfcGeometricRepresentationItem.__json__(self)
        attrs = { 'HatchLineAppearance': self.HatchLineAppearance, 'StartOfNextHatchLine': self.StartOfNextHatchLine, 'PointOfReferenceHatchLine': self.PointOfReferenceHatchLine, 'PatternStart': self.PatternStart, 'HatchLineAngle': self.HatchLineAngle }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcIndexedColourMap(IfcPresentationItem):
    ...
    def __json__(self):
        sup = IfcPresentationItem.__json__(self)
        attrs = { 'MappedTo': self.MappedTo, 'Opacity': self.Opacity, 'Colours': self.Colours, 'ColourIndex': self.ColourIndex }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPointOnSurface(IfcPoint):
    ...
    def __json__(self):
        ...
        attrs = { 'BasisSurface': self.BasisSurface, 'PointParameterU': self.PointParameterU, 'PointParameterV': self.PointParameterV }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPresentationLayerWithStyle(IfcPresentationLayerAssignment):
    ...
    def __json__(self):
        ...
        attrs = { 'LayerOn': self.LayerOn, 'LayerFrozen': self.LayerFrozen, 'LayerBlocked': self.LayerBlocked, 'LayerStyles': self.LayerStyles }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTextStyleTextModel(IfcPresentationItem):
    ...
    def __json__(self):
        sup = IfcPresentationItem.__json__(self)
        attrs = { 'TextIndent': self.TextIndent, 'TextAlign': self.TextAlign, 'TextDecoration': self.TextDecoration, 'LetterSpacing': self.LetterSpacing, 'WordSpacing': self.WordSpacing, 'TextTransform': self.TextTransform, 'LineHeight': self.LineHeight }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialLayerSetUsage(IfcMaterialUsageDefinition):
    ...
    def __json__(self):
        ...
        attrs = { 'ForLayerSet': self.ForLayerSet, 'LayerSetDirection': self.LayerSetDirection, 'DirectionSense': self.DirectionSense, 'OffsetFromReferenceLine': self.OffsetFromReferenceLine, 'ReferenceExtent': self.ReferenceExtent }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcApplication(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'ApplicationDeveloper': self.ApplicationDeveloper, 'Version': self.Version, 'ApplicationFullName': self.ApplicationFullName, 'ApplicationIdentifier': self.ApplicationIdentifier }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTrapeziumProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'BottomXDim': self.BottomXDim, 'TopXDim': self.TopXDim, 'YDim': self.YDim, 'TopXOffset': self.TopXOffset }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTelecomAddress(IfcAddress):
    ...
    def __json__(self):
        ...
        attrs = { 'TelephoneNumbers': self.TelephoneNumbers, 'FacsimileNumbers': self.FacsimileNumbers, 'PagerNumber': self.PagerNumber, 'ElectronicMailAddresses': self.ElectronicMailAddresses, 'WWWHomePageURL': self.WWWHomePageURL, 'MessagingIDs': self.MessagingIDs }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTaskTime(IfcSchedulingTime):
    ...
    def __json__(self):
        sup = IfcSchedulingTime.__json__(self)
        attrs = { 'DurationType': self.DurationType, 'ScheduleDuration': self.ScheduleDuration, 'ScheduleStart': self.ScheduleStart, 'ScheduleFinish': self.ScheduleFinish, 'EarlyStart': self.EarlyStart, 'EarlyFinish': self.EarlyFinish, 'LateStart': self.LateStart, 'LateFinish': self.LateFinish, 'FreeFloat': self.FreeFloat, 'TotalFloat': self.TotalFloat, 'IsCritical': self.IsCritical, 'StatusTime': self.StatusTime, 'ActualDuration': self.ActualDuration, 'ActualStart': self.ActualStart, 'ActualFinish': self.ActualFinish, 'RemainingTime': self.RemainingTime, 'Completion': self.Completion }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLightSource(IfcGeometricRepresentationItem):
    ...
    def __json__(self):
        sup = IfcGeometricRepresentationItem.__json__(self)
        attrs = { 'Name': self.Name, 'LightColour': self.LightColour, 'AmbientIntensity': self.AmbientIntensity, 'Intensity': self.Intensity }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPostalAddress(IfcAddress):
    ...
    def __json__(self):
        sup = IfcAddress.__json__(self)
        attrs = { 'InternalLocation': self.InternalLocation, 'AddressLines': self.AddressLines, 'PostalBox': self.PostalBox, 'Town': self.Town, 'Region': self.Region, 'PostalCode': self.PostalCode, 'Country': self.Country }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcOwnerHistory(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'OwningUser': self.OwningUser, 'OwningApplication': self.OwningApplication, 'State': self.State, 'ChangeAction': self.ChangeAction, 'LastModifiedDate': self.LastModifiedDate, 'LastModifyingUser': self.LastModifyingUser, 'LastModifyingApplication': self.LastModifyingApplication, 'CreationDate': self.CreationDate }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCurrencyRelationship(IfcResourceLevelRelationship):
    ...
    def __json__(self):
        ...
        attrs = { 'RelatingMonetaryUnit': self.RelatingMonetaryUnit, 'RelatedMonetaryUnit': self.RelatedMonetaryUnit, 'ExchangeRate': self.ExchangeRate, 'RateDateTime': self.RateDateTime, 'RateSource': self.RateSource }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCShapeProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'Depth': self.Depth, 'Width': self.Width, 'WallThickness': self.WallThickness, 'Girth': self.Girth, 'InternalFilletRadius': self.InternalFilletRadius }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRepresentation(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'ContextOfItems': self.ContextOfItems, 'RepresentationIdentifier': self.RepresentationIdentifier, 'RepresentationType': self.RepresentationType, 'Items': self.Items }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSectionReinforcementProperties(IfcPreDefinedProperties):
    ...
    def __json__(self):
        ...
        attrs = { 'LongitudinalStartPosition': self.LongitudinalStartPosition, 'LongitudinalEndPosition': self.LongitudinalEndPosition, 'TransversePosition': self.TransversePosition, 'ReinforcementRole': self.ReinforcementRole, 'SectionDefinition': self.SectionDefinition, 'CrossSectionReinforcementDefinitions': self.CrossSectionReinforcementDefinitions }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCoordinateReferenceSystem(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'GeodeticDatum': self.GeodeticDatum, 'VerticalDatum': self.VerticalDatum }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSectionedSpine(IfcGeometricRepresentationItem):
    ...
    def __json__(self):
        sup = IfcGeometricRepresentationItem.__json__(self)
        attrs = { 'SpineCurve': self.SpineCurve, 'CrossSections': self.CrossSections, 'CrossSectionPositions': self.CrossSectionPositions }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSurfaceCurve(IfcCurve):
    ...
    def __json__(self):
        sup = IfcCurve.__json__(self)
        attrs = { 'Curve3D': self.Curve3D, 'AssociatedGeometry': self.AssociatedGeometry, 'MasterRepresentation': self.MasterRepresentation }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCurveStyle(IfcPresentationStyle):
    ...
    def __json__(self):
        sup = IfcPresentationStyle.__json__(self)
        attrs = { 'CurveFont': self.CurveFont, 'CurveWidth': self.CurveWidth, 'CurveColour': self.CurveColour, 'ModelOrDraughting': self.ModelOrDraughting }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialLayer(IfcMaterialDefinition):
    ...
    def __json__(self):
        sup = IfcMaterialDefinition.__json__(self)
        attrs = { 'Material': self.Material, 'LayerThickness': self.LayerThickness, 'IsVentilated': self.IsVentilated, 'Name': self.Name, 'Description': self.Description, 'Category': self.Category, 'Priority': self.Priority }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcIShapeProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'OverallWidth': self.OverallWidth, 'OverallDepth': self.OverallDepth, 'WebThickness': self.WebThickness, 'FlangeThickness': self.FlangeThickness, 'FilletRadius': self.FilletRadius, 'FlangeEdgeRadius': self.FlangeEdgeRadius, 'FlangeSlope': self.FlangeSlope }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcConnectionPointGeometry(IfcConnectionGeometry):
    ...
    def __json__(self):
        ...
        attrs = { 'PointOnRelatingElement': self.PointOnRelatingElement, 'PointOnRelatedElement': self.PointOnRelatedElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTShapeProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'Depth': self.Depth, 'FlangeWidth': self.FlangeWidth, 'WebThickness': self.WebThickness, 'FlangeThickness': self.FlangeThickness, 'FilletRadius': self.FilletRadius, 'FlangeEdgeRadius': self.FlangeEdgeRadius, 'WebEdgeRadius': self.WebEdgeRadius, 'WebSlope': self.WebSlope, 'FlangeSlope': self.FlangeSlope }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcConnectionPointEccentricity(IfcConnectionPointGeometry):
    ...
    def __json__(self):
        ...
        attrs = { 'EccentricityInX': self.EccentricityInX, 'EccentricityInY': self.EccentricityInY, 'EccentricityInZ': self.EccentricityInZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLShapeProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'Depth': self.Depth, 'Width': self.Width, 'Thickness': self.Thickness, 'FilletRadius': self.FilletRadius, 'EdgeRadius': self.EdgeRadius, 'LegSlope': self.LegSlope }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialConstituent(IfcMaterialDefinition):
    ...
    def __json__(self):
        sup = IfcMaterialDefinition.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'Material': self.Material, 'Fraction': self.Fraction, 'Category': self.Category }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPhysicalComplexQuantity(IfcPhysicalQuantity):
    ...
    def __json__(self):
        sup = IfcPhysicalQuantity.__json__(self)
        attrs = { 'HasQuantities': self.HasQuantities, 'Discrimination': self.Discrimination, 'Quality': self.Quality, 'Usage': self.Usage }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcConstraint(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'ConstraintGrade': self.ConstraintGrade, 'ConstraintSource': self.ConstraintSource, 'CreatingActor': self.CreatingActor, 'CreationTime': self.CreationTime, 'UserDefinedGrade': self.UserDefinedGrade }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelSequence(IfcRelConnects):
    ...
    def __json__(self):
        ...
        attrs = { 'RelatingProcess': self.RelatingProcess, 'RelatedProcess': self.RelatedProcess, 'TimeLag': self.TimeLag, 'SequenceType': self.SequenceType, 'UserDefinedSequenceType': self.UserDefinedSequenceType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcResourceTime(IfcSchedulingTime):
    ...
    def __json__(self):
        sup = IfcSchedulingTime.__json__(self)
        attrs = { 'ScheduleWork': self.ScheduleWork, 'ScheduleUsage': self.ScheduleUsage, 'ScheduleStart': self.ScheduleStart, 'ScheduleFinish': self.ScheduleFinish, 'ScheduleContour': self.ScheduleContour, 'LevelingDelay': self.LevelingDelay, 'IsOverAllocated': self.IsOverAllocated, 'StatusTime': self.StatusTime, 'ActualWork': self.ActualWork, 'ActualUsage': self.ActualUsage, 'ActualStart': self.ActualStart, 'ActualFinish': self.ActualFinish, 'RemainingWork': self.RemainingWork, 'RemainingUsage': self.RemainingUsage, 'Completion': self.Completion }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSurfaceTexture(IfcPresentationItem):
    ...
    def __json__(self):
        sup = IfcPresentationItem.__json__(self)
        attrs = { 'RepeatS': self.RepeatS, 'RepeatT': self.RepeatT, 'Mode': self.Mode, 'TextureTransform': self.TextureTransform, 'Parameter': self.Parameter }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelSpaceBoundary(IfcRelConnects):
    ...
    def __json__(self):
        sup = IfcRelConnects.__json__(self)
        attrs = { 'RelatingSpace': self.RelatingSpace, 'RelatedBuildingElement': self.RelatedBuildingElement, 'ConnectionGeometry': self.ConnectionGeometry, 'PhysicalOrVirtualBoundary': self.PhysicalOrVirtualBoundary, 'InternalOrExternalBoundary': self.InternalOrExternalBoundary }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcAppliedValue(IfcEntity):
    ...
    def __json__(self):
        sup = IfcEntity.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'AppliedValue': self.AppliedValue, 'UnitBasis': self.UnitBasis, 'ApplicableDate': self.ApplicableDate, 'FixedUntilDate': self.FixedUntilDate, 'Category': self.Category, 'Condition': self.Condition, 'ArithmeticOperator': self.ArithmeticOperator, 'Components': self.Components }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcBSplineSurface(IfcBoundedSurface):
    ...
    def __json__(self):
        sup = IfcBoundedSurface.__json__(self)
        attrs = { 'UDegree': self.UDegree, 'VDegree': self.VDegree, 'ControlPointsList': self.ControlPointsList, 'SurfaceForm': self.SurfaceForm, 'UClosed': self.UClosed, 'VClosed': self.VClosed, 'SelfIntersect': self.SelfIntersect }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcZShapeProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'Depth': self.Depth, 'FlangeWidth': self.FlangeWidth, 'WebThickness': self.WebThickness, 'FlangeThickness': self.FlangeThickness, 'FilletRadius': self.FilletRadius, 'EdgeRadius': self.EdgeRadius }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDistanceExpression(IfcGeometricRepresentationItem):
    ...
    def __json__(self):
        sup = IfcGeometricRepresentationItem.__json__(self)
        attrs = { 'DistanceAlong': self.DistanceAlong, 'OffsetLateral': self.OffsetLateral, 'OffsetVertical': self.OffsetVertical, 'OffsetLongitudinal': self.OffsetLongitudinal, 'AlongHorizontal': self.AlongHorizontal }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcAsymmetricIShapeProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'BottomFlangeWidth': self.BottomFlangeWidth, 'OverallDepth': self.OverallDepth, 'WebThickness': self.WebThickness, 'BottomFlangeThickness': self.BottomFlangeThickness, 'BottomFlangeFilletRadius': self.BottomFlangeFilletRadius, 'TopFlangeWidth': self.TopFlangeWidth, 'TopFlangeThickness': self.TopFlangeThickness, 'TopFlangeFilletRadius': self.TopFlangeFilletRadius, 'BottomFlangeEdgeRadius': self.BottomFlangeEdgeRadius, 'BottomFlangeSlope': self.BottomFlangeSlope, 'TopFlangeEdgeRadius': self.TopFlangeEdgeRadius, 'TopFlangeSlope': self.TopFlangeSlope }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRectangularTrimmedSurface(IfcBoundedSurface):
    ...
    def __json__(self):
        sup = IfcBoundedSurface.__json__(self)
        attrs = { 'BasisSurface': self.BasisSurface, 'U1': self.U1, 'V1': self.V1, 'U2': self.U2, 'V2': self.V2, 'Usense': self.Usense, 'Vsense': self.Vsense }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDocumentInformation(IfcExternalInformation):
    ...
    def __json__(self):
        ...
        attrs = { 'Identification': self.Identification, 'Name': self.Name, 'Description': self.Description, 'Location': self.Location, 'Purpose': self.Purpose, 'IntendedUse': self.IntendedUse, 'Scope': self.Scope, 'Revision': self.Revision, 'DocumentOwner': self.DocumentOwner, 'Editors': self.Editors, 'CreationTime': self.CreationTime, 'LastRevisionTime': self.LastRevisionTime, 'ElectronicFormat': self.ElectronicFormat, 'ValidFrom': self.ValidFrom, 'ValidUntil': self.ValidUntil, 'Confidentiality': self.Confidentiality, 'Status': self.Status }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPropertyDependencyRelationship(IfcResourceLevelRelationship):
    ...
    def __json__(self):
        sup = IfcResourceLevelRelationship.__json__(self)
        attrs = { 'DependingProperty': self.DependingProperty, 'DependantProperty': self.DependantProperty, 'Expression': self.Expression }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSurfaceReinforcementArea(IfcStructuralLoadOrResult):
    ...
    def __json__(self):
        ...
        attrs = { 'SurfaceReinforcement1': self.SurfaceReinforcement1, 'SurfaceReinforcement2': self.SurfaceReinforcement2, 'ShearReinforcement': self.ShearReinforcement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCurveStyleFontPattern(IfcPresentationItem):
    ...
    def __json__(self):
        sup = IfcPresentationItem.__json__(self)
        attrs = { 'VisibleSegmentLength': self.VisibleSegmentLength, 'InvisibleSegmentLength': self.InvisibleSegmentLength }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcBoundaryFaceCondition(IfcBoundaryCondition):
    ...
    def __json__(self):
        ...
        attrs = { 'TranslationalStiffnessByAreaX': self.TranslationalStiffnessByAreaX, 'TranslationalStiffnessByAreaY': self.TranslationalStiffnessByAreaY, 'TranslationalStiffnessByAreaZ': self.TranslationalStiffnessByAreaZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcEventTime(IfcSchedulingTime):
    ...
    def __json__(self):
        sup = IfcSchedulingTime.__json__(self)
        attrs = { 'ActualDate': self.ActualDate, 'EarlyDate': self.EarlyDate, 'LateDate': self.LateDate, 'ScheduleDate': self.ScheduleDate }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcUShapeProfileDef(IfcParameterizedProfileDef):
    ...
    def __json__(self):
        sup = IfcParameterizedProfileDef.__json__(self)
        attrs = { 'Depth': self.Depth, 'FlangeWidth': self.FlangeWidth, 'WebThickness': self.WebThickness, 'FlangeThickness': self.FlangeThickness, 'FilletRadius': self.FilletRadius, 'EdgeRadius': self.EdgeRadius, 'FlangeSlope': self.FlangeSlope }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRectangleHollowProfileDef(IfcRectangleProfileDef):
    ...
    def __json__(self):
        ...
        attrs = { 'WallThickness': self.WallThickness, 'InnerFilletRadius': self.InnerFilletRadius, 'OuterFilletRadius': self.OuterFilletRadius }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelInterferesElements(IfcRelConnects):
    ...
    def __json__(self):
        sup = IfcRelConnects.__json__(self)
        attrs = { 'RelatingElement': self.RelatingElement, 'RelatedElement': self.RelatedElement, 'InterferenceGeometry': self.InterferenceGeometry, 'InterferenceType': self.InterferenceType, 'ImpliedOrder': self.ImpliedOrder }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialLayerSet(IfcMaterialDefinition):
    ...
    def __json__(self):
        sup = IfcMaterialDefinition.__json__(self)
        attrs = { 'MaterialLayers': self.MaterialLayers, 'LayerSetName': self.LayerSetName, 'Description': self.Description }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialProfileSetUsage(IfcMaterialUsageDefinition):
    ...
    def __json__(self):
        sup = IfcMaterialUsageDefinition.__json__(self)
        attrs = { 'ForProfileSet': self.ForProfileSet, 'CardinalPoint': self.CardinalPoint, 'ReferenceExtent': self.ReferenceExtent }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialProfileSet(IfcMaterialDefinition):
    ...
    def __json__(self):
        sup = IfcMaterialDefinition.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'MaterialProfiles': self.MaterialProfiles, 'CompositeProfile': self.CompositeProfile }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDocumentInformationRelationship(IfcResourceLevelRelationship):
    ...
    def __json__(self):
        sup = IfcResourceLevelRelationship.__json__(self)
        attrs = { 'RelatingDocument': self.RelatingDocument, 'RelatedDocuments': self.RelatedDocuments, 'RelationshipType': self.RelationshipType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcConnectionSurfaceGeometry(IfcConnectionGeometry):
    ...
    def __json__(self):
        sup = IfcConnectionGeometry.__json__(self)
        attrs = { 'SurfaceOnRelatingElement': self.SurfaceOnRelatingElement, 'SurfaceOnRelatedElement': self.SurfaceOnRelatedElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcGeometricRepresentationContext(IfcRepresentationContext):
    ...
    def __json__(self):
        ...
        attrs = { 'CoordinateSpaceDimension': self.CoordinateSpaceDimension, 'Precision': self.Precision, 'WorldCoordinateSystem': self.WorldCoordinateSystem, 'TrueNorth': self.TrueNorth }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcConnectionVolumeGeometry(IfcConnectionGeometry):
    ...
    def __json__(self):
        sup = IfcConnectionGeometry.__json__(self)
        attrs = { 'VolumeOnRelatingElement': self.VolumeOnRelatingElement, 'VolumeOnRelatedElement': self.VolumeOnRelatedElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSurfaceStyleRendering(IfcSurfaceStyleShading):
    ...
    def __json__(self):
        ...
        attrs = { 'DiffuseColour': self.DiffuseColour, 'TransmissionColour': self.TransmissionColour, 'DiffuseTransmissionColour': self.DiffuseTransmissionColour, 'ReflectionColour': self.ReflectionColour, 'SpecularColour': self.SpecularColour, 'SpecularHighlight': self.SpecularHighlight, 'ReflectanceMethod': self.ReflectanceMethod }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTextStyleFontModel(IfcPreDefinedTextFont):
    ...
    def __json__(self):
        ...
        attrs = { 'FontFamily': self.FontFamily, 'FontStyle': self.FontStyle, 'FontVariant': self.FontVariant, 'FontWeight': self.FontWeight, 'FontSize': self.FontSize }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialRelationship(IfcResourceLevelRelationship):
    ...
    def __json__(self):
        sup = IfcResourceLevelRelationship.__json__(self)
        attrs = { 'RelatingMaterial': self.RelatingMaterial, 'RelatedMaterials': self.RelatedMaterials, 'Expression': self.Expression }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcClassification(IfcExternalInformation):
    ...
    def __json__(self):
        sup = IfcExternalInformation.__json__(self)
        attrs = { 'Source': self.Source, 'Edition': self.Edition, 'EditionDate': self.EditionDate, 'Name': self.Name, 'Description': self.Description, 'Location': self.Location, 'ReferenceTokens': self.ReferenceTokens }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMaterialProfile(IfcMaterialDefinition):
    ...
    def __json__(self):
        sup = IfcMaterialDefinition.__json__(self)
        attrs = { 'Name': self.Name, 'Description': self.Description, 'Material': self.Material, 'Profile': self.Profile, 'Priority': self.Priority, 'Category': self.Category }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcReinforcementBarProperties(IfcPreDefinedProperties):
    ...
    def __json__(self):
        sup = IfcPreDefinedProperties.__json__(self)
        attrs = { 'TotalCrossSectionArea': self.TotalCrossSectionArea, 'SteelGrade': self.SteelGrade, 'BarSurface': self.BarSurface, 'EffectiveDepth': self.EffectiveDepth, 'NominalBarDiameter': self.NominalBarDiameter, 'BarCount': self.BarCount }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLibraryReference(IfcExternalReference):
    ...
    def __json__(self):
        sup = IfcExternalReference.__json__(self)
        attrs = { 'Description': self.Description, 'Language': self.Language, 'ReferencedLibrary': self.ReferencedLibrary }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSweptDiskSolid(IfcSolidModel):
    ...
    def __json__(self):
        ...
        attrs = { 'Directrix': self.Directrix, 'Radius': self.Radius, 'InnerRadius': self.InnerRadius, 'StartParam': self.StartParam, 'EndParam': self.EndParam }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelConnectsElements(IfcRelConnects):
    ...
    def __json__(self):
        sup = IfcRelConnects.__json__(self)
        attrs = { 'ConnectionGeometry': self.ConnectionGeometry, 'RelatingElement': self.RelatingElement, 'RelatedElement': self.RelatedElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMetric(IfcConstraint):
    ...
    def __json__(self):
        ...
        attrs = { 'Benchmark': self.Benchmark, 'ValueSource': self.ValueSource, 'DataValue': self.DataValue, 'ReferencePath': self.ReferencePath }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcConnectionCurveGeometry(IfcConnectionGeometry):
    ...
    def __json__(self):
        sup = IfcConnectionGeometry.__json__(self)
        attrs = { 'CurveOnRelatingElement': self.CurveOnRelatingElement, 'CurveOnRelatedElement': self.CurveOnRelatedElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcObjective(IfcConstraint):
    ...
    def __json__(self):
        sup = IfcConstraint.__json__(self)
        attrs = { 'BenchmarkValues': self.BenchmarkValues, 'LogicalAggregator': self.LogicalAggregator, 'ObjectiveQualifier': self.ObjectiveQualifier, 'UserDefinedQualifier': self.UserDefinedQualifier }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcAlignment2DVerticalSegment(IfcAlignment2DSegment):
    ...
    def __json__(self):
        sup = IfcAlignment2DSegment.__json__(self)
        attrs = { 'StartDistAlong': self.StartDistAlong, 'HorizontalLength': self.HorizontalLength, 'StartHeight': self.StartHeight, 'StartGradient': self.StartGradient }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelConnectsPorts(IfcRelConnects):
    ...
    def __json__(self):
        sup = IfcRelConnects.__json__(self)
        attrs = { 'RelatingPort': self.RelatingPort, 'RelatedPort': self.RelatedPort, 'RealizingElement': self.RealizingElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelFillsElement(IfcRelConnects):
    ...
    def __json__(self):
        sup = IfcRelConnects.__json__(self)
        attrs = { 'RelatingOpeningElement': self.RelatingOpeningElement, 'RelatedBuildingElement': self.RelatedBuildingElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPixelTexture(IfcSurfaceTexture):
    ...
    def __json__(self):
        ...
        attrs = { 'Width': self.Width, 'Height': self.Height, 'ColourComponents': self.ColourComponents, 'Pixel': self.Pixel }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcFailureConnectionCondition(IfcStructuralConnectionCondition):
    ...
    def __json__(self):
        sup = IfcStructuralConnectionCondition.__json__(self)
        attrs = { 'TensionFailureX': self.TensionFailureX, 'TensionFailureY': self.TensionFailureY, 'TensionFailureZ': self.TensionFailureZ, 'CompressionFailureX': self.CompressionFailureX, 'CompressionFailureY': self.CompressionFailureY, 'CompressionFailureZ': self.CompressionFailureZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLightSourcePositional(IfcLightSource):
    ...
    def __json__(self):
        sup = IfcLightSource.__json__(self)
        attrs = { 'Position': self.Position, 'Radius': self.Radius, 'ConstantAttenuation': self.ConstantAttenuation, 'DistanceAttenuation': self.DistanceAttenuation, 'QuadricAttenuation': self.QuadricAttenuation }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLibraryInformation(IfcExternalInformation):
    ...
    def __json__(self):
        sup = IfcExternalInformation.__json__(self)
        attrs = { 'Name': self.Name, 'Version': self.Version, 'Publisher': self.Publisher, 'VersionDate': self.VersionDate, 'Location': self.Location, 'Description': self.Description }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcContext(IfcObjectDefinition):
    ...
    def __json__(self):
        ...
        attrs = { 'ObjectType': self.ObjectType, 'LongName': self.LongName, 'Phase': self.Phase, 'RepresentationContexts': self.RepresentationContexts, 'UnitsInContext': self.UnitsInContext }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCurveSegment2D(IfcBoundedCurve):
    ...
    def __json__(self):
        sup = IfcBoundedCurve.__json__(self)
        attrs = { 'StartPoint': self.StartPoint, 'StartDirection': self.StartDirection, 'SegmentLength': self.SegmentLength }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCurveBoundedPlane(IfcBoundedSurface):
    ...
    def __json__(self):
        sup = IfcBoundedSurface.__json__(self)
        attrs = { 'BasisSurface': self.BasisSurface, 'OuterBoundary': self.OuterBoundary, 'InnerBoundaries': self.InnerBoundaries }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLightSourceGoniometric(IfcLightSource):
    ...
    def __json__(self):
        sup = IfcLightSource.__json__(self)
        attrs = { 'Position': self.Position, 'ColourAppearance': self.ColourAppearance, 'ColourTemperature': self.ColourTemperature, 'LuminousFlux': self.LuminousFlux, 'LightEmissionSource': self.LightEmissionSource, 'LightDistributionDataSource': self.LightDistributionDataSource }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcBoundaryEdgeCondition(IfcBoundaryCondition):
    ...
    def __json__(self):
        sup = IfcBoundaryCondition.__json__(self)
        attrs = { 'TranslationalStiffnessByLengthX': self.TranslationalStiffnessByLengthX, 'TranslationalStiffnessByLengthY': self.TranslationalStiffnessByLengthY, 'TranslationalStiffnessByLengthZ': self.TranslationalStiffnessByLengthZ, 'RotationalStiffnessByLengthX': self.RotationalStiffnessByLengthX, 'RotationalStiffnessByLengthY': self.RotationalStiffnessByLengthY, 'RotationalStiffnessByLengthZ': self.RotationalStiffnessByLengthZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelConnectsPathElements(IfcRelConnectsElements):
    ...
    def __json__(self):
        ...
        attrs = { 'RelatingPriorities': self.RelatingPriorities, 'RelatedPriorities': self.RelatedPriorities, 'RelatedConnectionType': self.RelatedConnectionType, 'RelatingConnectionType': self.RelatingConnectionType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcBSplineCurve(IfcBoundedCurve):
    ...
    def __json__(self):
        sup = IfcBoundedCurve.__json__(self)
        attrs = { 'Degree': self.Degree, 'ControlPointsList': self.ControlPointsList, 'CurveForm': self.CurveForm, 'ClosedCurve': self.ClosedCurve, 'SelfIntersect': self.SelfIntersect }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPropertySetTemplate(IfcPropertyTemplateDefinition):
    ...
    def __json__(self):
        sup = IfcPropertyTemplateDefinition.__json__(self)
        attrs = { 'TemplateType': self.TemplateType, 'ApplicableEntity': self.ApplicableEntity, 'HasPropertyTemplates': self.HasPropertyTemplates }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSimplePropertyTemplate(IfcPropertyTemplate):
    ...
    def __json__(self):
        ...
        attrs = { 'TemplateType': self.TemplateType, 'PrimaryMeasureType': self.PrimaryMeasureType, 'SecondaryMeasureType': self.SecondaryMeasureType, 'Enumerators': self.Enumerators, 'PrimaryUnit': self.PrimaryUnit, 'SecondaryUnit': self.SecondaryUnit, 'Expression': self.Expression, 'AccessState': self.AccessState }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcBoundaryNodeCondition(IfcBoundaryCondition):
    ...
    def __json__(self):
        sup = IfcBoundaryCondition.__json__(self)
        attrs = { 'TranslationalStiffnessX': self.TranslationalStiffnessX, 'TranslationalStiffnessY': self.TranslationalStiffnessY, 'TranslationalStiffnessZ': self.TranslationalStiffnessZ, 'RotationalStiffnessX': self.RotationalStiffnessX, 'RotationalStiffnessY': self.RotationalStiffnessY, 'RotationalStiffnessZ': self.RotationalStiffnessZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcComplexPropertyTemplate(IfcPropertyTemplate):
    ...
    def __json__(self):
        sup = IfcPropertyTemplate.__json__(self)
        attrs = { 'UsageName': self.UsageName, 'TemplateType': self.TemplateType, 'HasPropertyTemplates': self.HasPropertyTemplates }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelConnectsStructuralMember(IfcRelConnects):
    ...
    def __json__(self):
        sup = IfcRelConnects.__json__(self)
        attrs = { 'RelatingStructuralMember': self.RelatingStructuralMember, 'RelatedStructuralConnection': self.RelatedStructuralConnection, 'AppliedCondition': self.AppliedCondition, 'AdditionalConditions': self.AdditionalConditions, 'SupportedLength': self.SupportedLength, 'ConditionCoordinateSystem': self.ConditionCoordinateSystem }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLinearPlacement(IfcObjectPlacement):
    ...
    def __json__(self):
        sup = IfcObjectPlacement.__json__(self)
        attrs = { 'PlacementRelTo': self.PlacementRelTo, 'Distance': self.Distance, 'Orientation': self.Orientation, 'CartesianPosition': self.CartesianPosition }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTrimmedCurve(IfcBoundedCurve):
    ...
    def __json__(self):
        sup = IfcBoundedCurve.__json__(self)
        attrs = { 'BasisCurve': self.BasisCurve, 'Trim1': self.Trim1, 'Trim2': self.Trim2, 'SenseAgreement': self.SenseAgreement, 'MasterRepresentation': self.MasterRepresentation }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcBSplineSurfaceWithKnots(IfcBSplineSurface):
    ...
    def __json__(self):
        ...
        attrs = { 'UMultiplicities': self.UMultiplicities, 'VMultiplicities': self.VMultiplicities, 'UKnots': self.UKnots, 'VKnots': self.VKnots, 'KnotSpec': self.KnotSpec }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcGeometricRepresentationSubContext(IfcGeometricRepresentationContext):
    ...
    def __json__(self):
        ...
        attrs = { 'ParentContext': self.ParentContext, 'TargetScale': self.TargetScale, 'TargetView': self.TargetView, 'UserDefinedTargetView': self.UserDefinedTargetView }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcLightSourceSpot(IfcLightSourcePositional):
    ...
    def __json__(self):
        ...
        attrs = { 'Orientation': self.Orientation, 'ConcentrationExponent': self.ConcentrationExponent, 'SpreadAngle': self.SpreadAngle, 'BeamWidthAngle': self.BeamWidthAngle }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStructuralLoadSingleForce(IfcStructuralLoadStatic):
    ...
    def __json__(self):
        ...
        attrs = { 'ForceX': self.ForceX, 'ForceY': self.ForceY, 'ForceZ': self.ForceZ, 'MomentX': self.MomentX, 'MomentY': self.MomentY, 'MomentZ': self.MomentZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTypeProcess(IfcTypeObject):
    ...
    def __json__(self):
        ...
        attrs = { 'Identification': self.Identification, 'LongDescription': self.LongDescription, 'ProcessType': self.ProcessType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTransitionCurveSegment2D(IfcCurveSegment2D):
    ...
    def __json__(self):
        sup = IfcCurveSegment2D.__json__(self)
        attrs = { 'StartRadius': self.StartRadius, 'EndRadius': self.EndRadius, 'IsStartRadiusCCW': self.IsStartRadiusCCW, 'IsEndRadiusCCW': self.IsEndRadiusCCW, 'TransitionCurveType': self.TransitionCurveType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTypeResource(IfcTypeObject):
    ...
    def __json__(self):
        sup = IfcTypeObject.__json__(self)
        attrs = { 'Identification': self.Identification, 'LongDescription': self.LongDescription, 'ResourceType': self.ResourceType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcRelVoidsElement(IfcRelDecomposes):
    ...
    def __json__(self):
        sup = IfcRelDecomposes.__json__(self)
        attrs = { 'RelatingBuildingElement': self.RelatingBuildingElement, 'RelatedOpeningElement': self.RelatedOpeningElement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcFixedReferenceSweptAreaSolid(IfcSweptAreaSolid):
    ...
    def __json__(self):
        sup = IfcSweptAreaSolid.__json__(self)
        attrs = { 'Directrix': self.Directrix, 'StartParam': self.StartParam, 'EndParam': self.EndParam, 'FixedReference': self.FixedReference }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStructuralLoadLinearForce(IfcStructuralLoadStatic):
    ...
    def __json__(self):
        sup = IfcStructuralLoadStatic.__json__(self)
        attrs = { 'LinearForceX': self.LinearForceX, 'LinearForceY': self.LinearForceY, 'LinearForceZ': self.LinearForceZ, 'LinearMomentX': self.LinearMomentX, 'LinearMomentY': self.LinearMomentY, 'LinearMomentZ': self.LinearMomentZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStructuralLoadSingleDisplacement(IfcStructuralLoadStatic):
    ...
    def __json__(self):
        sup = IfcStructuralLoadStatic.__json__(self)
        attrs = { 'DisplacementX': self.DisplacementX, 'DisplacementY': self.DisplacementY, 'DisplacementZ': self.DisplacementZ, 'RotationalDisplacementRX': self.RotationalDisplacementRX, 'RotationalDisplacementRY': self.RotationalDisplacementRY, 'RotationalDisplacementRZ': self.RotationalDisplacementRZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSurfaceCurveSweptAreaSolid(IfcSweptAreaSolid):
    ...
    def __json__(self):
        sup = IfcSweptAreaSolid.__json__(self)
        attrs = { 'Directrix': self.Directrix, 'StartParam': self.StartParam, 'EndParam': self.EndParam, 'ReferenceSurface': self.ReferenceSurface }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPropertyBoundedValue(IfcSimpleProperty):
    ...
    def __json__(self):
        sup = IfcSimpleProperty.__json__(self)
        attrs = { 'UpperBoundValue': self.UpperBoundValue, 'LowerBoundValue': self.LowerBoundValue, 'Unit': self.Unit, 'SetPointValue': self.SetPointValue }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcWindowStyle(IfcTypeProduct):
    ...
    def __json__(self):
        ...
        attrs = { 'ConstructionType': self.ConstructionType, 'OperationType': self.OperationType, 'ParameterTakesPrecedence': self.ParameterTakesPrecedence, 'Sizeable': self.Sizeable }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPropertyTableValue(IfcSimpleProperty):
    ...
    def __json__(self):
        sup = IfcSimpleProperty.__json__(self)
        attrs = { 'DefiningValues': self.DefiningValues, 'DefinedValues': self.DefinedValues, 'Expression': self.Expression, 'DefiningUnit': self.DefiningUnit, 'DefinedUnit': self.DefinedUnit, 'CurveInterpolation': self.CurveInterpolation }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDoorStyle(IfcTypeProduct):
    ...
    def __json__(self):
        sup = IfcTypeProduct.__json__(self)
        attrs = { 'OperationType': self.OperationType, 'ConstructionType': self.ConstructionType, 'ParameterTakesPrecedence': self.ParameterTakesPrecedence, 'Sizeable': self.Sizeable }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStructuralLoadPlanarForce(IfcStructuralLoadStatic):
    ...
    def __json__(self):
        sup = IfcStructuralLoadStatic.__json__(self)
        attrs = { 'PlanarForceX': self.PlanarForceX, 'PlanarForceY': self.PlanarForceY, 'PlanarForceZ': self.PlanarForceZ }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcEventType(IfcTypeProcess):
    ...
    def __json__(self):
        sup = IfcTypeProcess.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'EventTriggerType': self.EventTriggerType, 'UserDefinedEventTriggerType': self.UserDefinedEventTriggerType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCostSchedule(IfcControl):
    ...
    def __json__(self):
        sup = IfcControl.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'Status': self.Status, 'SubmittedOn': self.SubmittedOn, 'UpdateDate': self.UpdateDate }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStairFlight(IfcBuildingElement):
    ...
    def __json__(self):
        sup = IfcBuildingElement.__json__(self)
        attrs = { 'NumberOfRisers': self.NumberOfRisers, 'NumberOfTreads': self.NumberOfTreads, 'RiserHeight': self.RiserHeight, 'TreadLength': self.TreadLength, 'PredefinedType': self.PredefinedType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTask(IfcProcess):
    ...
    def __json__(self):
        ...
        attrs = { 'Status': self.Status, 'WorkMethod': self.WorkMethod, 'IsMilestone': self.IsMilestone, 'Priority': self.Priority, 'TaskTime': self.TaskTime, 'PredefinedType': self.PredefinedType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcWindow(IfcBuildingElement):
    ...
    def __json__(self):
        sup = IfcBuildingElement.__json__(self)
        attrs = { 'OverallHeight': self.OverallHeight, 'OverallWidth': self.OverallWidth, 'PredefinedType': self.PredefinedType, 'PartitioningType': self.PartitioningType, 'UserDefinedPartitioningType': self.UserDefinedPartitioningType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStructuralAnalysisModel(IfcSystem):
    ...
    def __json__(self):
        ...
        attrs = { 'PredefinedType': self.PredefinedType, 'OrientationOf2DPlane': self.OrientationOf2DPlane, 'LoadedBy': self.LoadedBy, 'HasResults': self.HasResults, 'SharedPlacement': self.SharedPlacement }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcPermeableCoveringProperties(IfcPreDefinedPropertySet):
    ...
    def __json__(self):
        ...
        attrs = { 'OperationType': self.OperationType, 'PanelPosition': self.PanelPosition, 'FrameDepth': self.FrameDepth, 'FrameThickness': self.FrameThickness, 'ShapeAspectStyle': self.ShapeAspectStyle }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcAsset(IfcGroup):
    ...
    def __json__(self):
        sup = IfcGroup.__json__(self)
        attrs = { 'Identification': self.Identification, 'OriginalValue': self.OriginalValue, 'CurrentValue': self.CurrentValue, 'TotalReplacementCost': self.TotalReplacementCost, 'Owner': self.Owner, 'User': self.User, 'ResponsiblePerson': self.ResponsiblePerson, 'IncorporationDate': self.IncorporationDate, 'DepreciatedValue': self.DepreciatedValue }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMechanicalFastener(IfcElementComponent):
    ...
    def __json__(self):
        sup = IfcElementComponent.__json__(self)
        attrs = { 'NominalDiameter': self.NominalDiameter, 'NominalLength': self.NominalLength, 'PredefinedType': self.PredefinedType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcEvent(IfcProcess):
    ...
    def __json__(self):
        sup = IfcProcess.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'EventTriggerType': self.EventTriggerType, 'UserDefinedEventTriggerType': self.UserDefinedEventTriggerType, 'EventOccurenceTime': self.EventOccurenceTime }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStructuralLoadGroup(IfcGroup):
    ...
    def __json__(self):
        sup = IfcGroup.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'ActionType': self.ActionType, 'ActionSource': self.ActionSource, 'Coefficient': self.Coefficient, 'Purpose': self.Purpose }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDoorLiningProperties(IfcPreDefinedPropertySet):
    ...
    def __json__(self):
        sup = IfcPreDefinedPropertySet.__json__(self)
        attrs = { 'LiningDepth': self.LiningDepth, 'LiningThickness': self.LiningThickness, 'ThresholdDepth': self.ThresholdDepth, 'ThresholdThickness': self.ThresholdThickness, 'TransomThickness': self.TransomThickness, 'TransomOffset': self.TransomOffset, 'LiningOffset': self.LiningOffset, 'ThresholdOffset': self.ThresholdOffset, 'CasingThickness': self.CasingThickness, 'CasingDepth': self.CasingDepth, 'ShapeAspectStyle': self.ShapeAspectStyle, 'LiningToPanelOffsetX': self.LiningToPanelOffsetX, 'LiningToPanelOffsetY': self.LiningToPanelOffsetY }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcWorkControl(IfcControl):
    ...
    def __json__(self):
        sup = IfcControl.__json__(self)
        attrs = { 'CreationDate': self.CreationDate, 'Creators': self.Creators, 'Purpose': self.Purpose, 'Duration': self.Duration, 'TotalFloat': self.TotalFloat, 'StartTime': self.StartTime, 'FinishTime': self.FinishTime }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDoorType(IfcBuildingElementType):
    ...
    def __json__(self):
        sup = IfcBuildingElementType.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'OperationType': self.OperationType, 'ParameterTakesPrecedence': self.ParameterTakesPrecedence, 'UserDefinedOperationType': self.UserDefinedOperationType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcWindowLiningProperties(IfcPreDefinedPropertySet):
    ...
    def __json__(self):
        sup = IfcPreDefinedPropertySet.__json__(self)
        attrs = { 'LiningDepth': self.LiningDepth, 'LiningThickness': self.LiningThickness, 'TransomThickness': self.TransomThickness, 'MullionThickness': self.MullionThickness, 'FirstTransomOffset': self.FirstTransomOffset, 'SecondTransomOffset': self.SecondTransomOffset, 'FirstMullionOffset': self.FirstMullionOffset, 'SecondMullionOffset': self.SecondMullionOffset, 'ShapeAspectStyle': self.ShapeAspectStyle, 'LiningOffset': self.LiningOffset, 'LiningToPanelOffsetX': self.LiningToPanelOffsetX, 'LiningToPanelOffsetY': self.LiningToPanelOffsetY }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDoor(IfcBuildingElement):
    ...
    def __json__(self):
        sup = IfcBuildingElement.__json__(self)
        attrs = { 'OverallHeight': self.OverallHeight, 'OverallWidth': self.OverallWidth, 'PredefinedType': self.PredefinedType, 'OperationType': self.OperationType, 'UserDefinedOperationType': self.UserDefinedOperationType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDoorPanelProperties(IfcPreDefinedPropertySet):
    ...
    def __json__(self):
        sup = IfcPreDefinedPropertySet.__json__(self)
        attrs = { 'PanelDepth': self.PanelDepth, 'PanelOperation': self.PanelOperation, 'PanelWidth': self.PanelWidth, 'PanelPosition': self.PanelPosition, 'ShapeAspectStyle': self.ShapeAspectStyle }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcWorkCalendar(IfcControl):
    ...
    def __json__(self):
        sup = IfcControl.__json__(self)
        attrs = { 'WorkingTimes': self.WorkingTimes, 'ExceptionTimes': self.ExceptionTimes, 'PredefinedType': self.PredefinedType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcReinforcementDefinitionProperties(IfcPreDefinedPropertySet):
    ...
    def __json__(self):
        sup = IfcPreDefinedPropertySet.__json__(self)
        attrs = { 'DefinitionType': self.DefinitionType, 'ReinforcementSectionDefinitions': self.ReinforcementSectionDefinitions }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcInventory(IfcGroup):
    ...
    def __json__(self):
        sup = IfcGroup.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'Jurisdiction': self.Jurisdiction, 'ResponsiblePersons': self.ResponsiblePersons, 'LastUpdateDate': self.LastUpdateDate, 'CurrentValue': self.CurrentValue, 'OriginalValue': self.OriginalValue }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcDistributionPort(IfcPort):
    ...
    def __json__(self):
        ...
        attrs = { 'FlowDirection': self.FlowDirection, 'PredefinedType': self.PredefinedType, 'SystemType': self.SystemType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcCostItem(IfcControl):
    ...
    def __json__(self):
        sup = IfcControl.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'CostValues': self.CostValues, 'CostQuantities': self.CostQuantities }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcStructuralResultGroup(IfcGroup):
    ...
    def __json__(self):
        sup = IfcGroup.__json__(self)
        attrs = { 'TheoryType': self.TheoryType, 'ResultForLoadGroup': self.ResultForLoadGroup, 'IsLinear': self.IsLinear }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcSite(IfcSpatialStructureElement):
    ...
    def __json__(self):
        sup = IfcSpatialStructureElement.__json__(self)
        attrs = { 'RefLatitude': self.RefLatitude, 'RefLongitude': self.RefLongitude, 'RefElevation': self.RefElevation, 'LandTitleNumber': self.LandTitleNumber, 'SiteAddress': self.SiteAddress }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcReinforcingBarType(IfcReinforcingElementType):
    ...
    def __json__(self):
        sup = IfcReinforcingElementType.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'NominalDiameter': self.NominalDiameter, 'CrossSectionArea': self.CrossSectionArea, 'BarLength': self.BarLength, 'BarSurface': self.BarSurface, 'BendingShapeCode': self.BendingShapeCode, 'BendingParameters': self.BendingParameters }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcReinforcingMeshType(IfcReinforcingElementType):
    ...
    def __json__(self):
        sup = IfcReinforcingElementType.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'MeshLength': self.MeshLength, 'MeshWidth': self.MeshWidth, 'LongitudinalBarNominalDiameter': self.LongitudinalBarNominalDiameter, 'TransverseBarNominalDiameter': self.TransverseBarNominalDiameter, 'LongitudinalBarCrossSectionArea': self.LongitudinalBarCrossSectionArea, 'TransverseBarCrossSectionArea': self.TransverseBarCrossSectionArea, 'LongitudinalBarSpacing': self.LongitudinalBarSpacing, 'TransverseBarSpacing': self.TransverseBarSpacing, 'BendingShapeCode': self.BendingShapeCode, 'BendingParameters': self.BendingParameters }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcReinforcingMesh(IfcReinforcingElement):
    ...
    def __json__(self):
        ...
        attrs = { 'MeshLength': self.MeshLength, 'MeshWidth': self.MeshWidth, 'LongitudinalBarNominalDiameter': self.LongitudinalBarNominalDiameter, 'TransverseBarNominalDiameter': self.TransverseBarNominalDiameter, 'LongitudinalBarCrossSectionArea': self.LongitudinalBarCrossSectionArea, 'TransverseBarCrossSectionArea': self.TransverseBarCrossSectionArea, 'LongitudinalBarSpacing': self.LongitudinalBarSpacing, 'TransverseBarSpacing': self.TransverseBarSpacing, 'PredefinedType': self.PredefinedType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcMechanicalFastenerType(IfcElementComponentType):
    ...
    def __json__(self):
        sup = IfcElementComponentType.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'NominalDiameter': self.NominalDiameter, 'NominalLength': self.NominalLength }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcBuilding(IfcSpatialStructureElement):
    ...
    def __json__(self):
        sup = IfcSpatialStructureElement.__json__(self)
        attrs = { 'ElevationOfRefHeight': self.ElevationOfRefHeight, 'ElevationOfTerrain': self.ElevationOfTerrain, 'BuildingAddress': self.BuildingAddress }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcWindowType(IfcBuildingElementType):
    ...
    def __json__(self):
        sup = IfcBuildingElementType.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'PartitioningType': self.PartitioningType, 'ParameterTakesPrecedence': self.ParameterTakesPrecedence, 'UserDefinedPartitioningType': self.UserDefinedPartitioningType }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTendon(IfcReinforcingElement):
    ...
    def __json__(self):
        sup = IfcReinforcingElement.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'NominalDiameter': self.NominalDiameter, 'CrossSectionArea': self.CrossSectionArea, 'TensionForce': self.TensionForce, 'PreStress': self.PreStress, 'FrictionCoefficient': self.FrictionCoefficient, 'AnchorageSlip': self.AnchorageSlip, 'MinCurvatureRadius': self.MinCurvatureRadius }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcReinforcingBar(IfcReinforcingElement):
    ...
    def __json__(self):
        sup = IfcReinforcingElement.__json__(self)
        attrs = { 'NominalDiameter': self.NominalDiameter, 'CrossSectionArea': self.CrossSectionArea, 'BarLength': self.BarLength, 'PredefinedType': self.PredefinedType, 'BarSurface': self.BarSurface }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
...
class IfcTendonType(IfcReinforcingElementType):
    ...
    def __json__(self):
        sup = IfcReinforcingElementType.__json__(self)
        attrs = { 'PredefinedType': self.PredefinedType, 'NominalDiameter': self.NominalDiameter, 'CrossSectionArea': self.CrossSectionArea, 'SheathDiameter': self.SheathDiameter }
        res = {'rtype': self.rtype }
        res.update(sup)
        res.update(attrs)
        return res
