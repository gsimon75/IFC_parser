from Ifc.ClassRegistry import ifc_class, ifc_abstract_class
from Ifc.IfcBase import IfcEntity, BOOLEAN, REAL, BINARY, INTEGER, NUMBER, STRING, LOGICAL
from Ifc.Misc import parse_uuid
